...
export function YearComparisonChart({ data, selectedFirms }: YearComparisonChartProps) {
  ...
  const standardizeFirmName = (name: string): string => {
    ...
    } else if (nameLower.includes('jpmorgan') || nameLower.includes('jp morgan') || nameLower === 'jpm') {
      return "jpmorgan";
  ...
  const firmMap = {
    ...
    "lpl financial": { key: "lplFinancial", display: "LPL Financial", color: "#4AFF91" },
    "goldman sachs": { key: "goldman", display: "Goldman Sachs", color: "#367639" },
    "jpmorgan": { key: "jpm", display: "JPMorgan", color: "#C99700" },
    ...
    "edward jones": { key: "edwardJones", display: "Edward Jones", color: "#007934" },
    "stifel": { key: "stifel", display: "Stifel", color: "#0E2240" }
  };
