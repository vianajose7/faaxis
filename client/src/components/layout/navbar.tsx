          ...
          <div className="flex flex-row items-center">
            ...
            <div className="hidden md:flex items-center ml-12 space-x-8 text-base font-bold">
              <Link href="/calculator" className="cursor-pointer">
                <span className={`${location === '/calculator' ? 'text-primary font-bold border-b-2 border-primary pb-1' : 'text-foreground'} hover:text-primary transition-colors`} aria-label="Deal Calculator tools">Deal Calculator</span>
              </Link>
              <Link href="/marketplace" className="cursor-pointer">
                <span className={`${location === '/marketplace' ? 'text-primary font-bold border-b-2 border-primary pb-1' : 'text-foreground'} hover:text-primary transition-colors`} aria-label="Practice Listings marketplace">Practice Listings</span>
              </Link>
              <Link href="/marketing" className="cursor-pointer">
                <span className={`${location === '/marketing' ? 'text-primary font-bold border-b-2 border-primary pb-1' : 'text-foreground'} hover:text-primary transition-colors`} aria-label="Marketing resources">Growth Marketing</span>
              </Link>
            </div>
          </div>
        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="hidden md:flex items-center">
            <Link href="/dashboard" className="cursor-pointer">
              <span className={`${location === '/dashboard' ? 'text-primary font-bold border-b-2 border-primary pb-1' : 'text-foreground'} hover:text-primary transition-colors mr-4`} aria-label="Dashboard">Dashboard</span>
            </Link>
            <div className="mr-4">
              <ThemeToggle />
            </div>
